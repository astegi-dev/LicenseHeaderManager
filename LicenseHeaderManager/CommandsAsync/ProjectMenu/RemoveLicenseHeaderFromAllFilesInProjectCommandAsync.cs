...
namespace LicenseHeaderManager.CommandsAsync.ProjectMenu
{
  ...
  /// Command handler
  /// </summary>
  internal sealed class RemoveLicenseHeaderFromAllFilesInProjectCommandAsync
  {
    /// <summary>
    /// Command ID.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RemoveLicenseHeaderFromAllFilesInProjectCommandAsync"/> class.
    ...
    {
      // Switch to the main thread - the call to AddCommand in RemoveLicenseHeaderFromAllFilesInProjectCommandAsync's constructor requires
      // the UI thread.
