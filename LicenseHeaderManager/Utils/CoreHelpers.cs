...
namespace LicenseHeaderManager.Utils
{
  internal static class CoreHelpers
  {
    ...
    /// <summary>
    /// Is executed when the Core reports that for given files (i. e. languages), no license header definition(s) could be found.
    /// </summary>
    /// <param name="message">Specific message reported by core, contains number of files for which no license header definition could be found.</param>
    /// <param name="licenseHeaderExtension">An Instance of <see cref="ILicenseHeaderExtension"/> used to display the languages page, which might
    /// be used to add the languages for which no definitions were found to the configuration.</param>
